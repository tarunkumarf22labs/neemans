// @ts-nocheck
import "./CustomSliderDrag.css";
import { useEffect, useState } from "uelements";


function CustomSliderDrag({
  productimages,
  productTitle,
  // productDesc,
  productName,
  ...
  return (
    <div className="drag-custom-slider-container">
      <div className="drag-nav-icons">
        <a
      ...
      <div className="drag-prod-desc">
        <div className="drag-prod-info">
      ...
      {slides.sizeData.length > 1 && (
        <div className="drag-all__slides__container">
          <div className="drag-all_slides">
            <div className="drag-slider__container">
              {slides.sizeData &&
                slides.sizeData.map((slide, index) => (
                  <div
                    key={slide.id}
                    className={`drag-slide__container ${
                      slides.currentSizeIndex === index ? "drag-active__size" : ""
                    }`}
                  ...
                  >
                    <h6 className="drag-size__text">{slide?.title}</h6>
                  </div>
                ))}
            </div>
          </div>
...
export default CustomSliderDrag;
