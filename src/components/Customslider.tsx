  ...
  return (
    <div className="custom-slider-container">
      <div className="nav-icons">
        <a
          href={`https://www.memara.co.uk/products/${productName}`}
          target="__blank"
        >
          <svg
            width="20"
      ...
      <div className="prod-desc">
        <div className="prod-info">
          <a href={`https://www.memara.co.uk/products/${productName}`}>
      ...
      <div id="main__container">
        <a href={`https://www.memara.co.uk/products/${productName}`} style={{textDecoration: "none"}}>
      ...
      {/* <div className="product-deatils">
        <p style={{textAlign: 'justify'}}>{productDesc.substring(0,80)}...<a className="show-more" href={`https://www.memara.co.uk/products/${productName}`}>SHOW MORE</a></p>
      </div> */}
