	...
	return (
		<div className="custom-slider-container">
			<div className="nav-icons">
				<a
					href={`https://deciwood.com/products/${productName}`}
					target="__blank"
        ...
        <p style={{textAlign: 'justify'}}>{productDesc.substring(0,80)}...<a className="show-more" href={`https://deciwood.com/products/${productName}`}>SHOW MORE</a></p>
      </div> */}
