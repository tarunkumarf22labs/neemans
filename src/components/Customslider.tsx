  ...
  return (
    <div className="custom-slider-container">
      <div className="nav-icons">
        <a
          href={`https://www.femmessanspeur.com/products/${productName}`}
          target="__blank"
      ...
      <div className="prod-desc">
        <div className="prod-info">
          <a href={`https://www.femmessanspeur.com/products/${productName}`} onClick={()=> getClickdata("VIEW_PRODUCT")}>
      ...
      <div id="main__container">
        <a href={`https://www.femmessanspeur.com/products/${productName}`} style={{textDecoration: "none"}} onClick={()=> getClickdata("VIEW_PRODUCT")}>
      ...
      {/* <div className="product-deatils">
        <p style={{textAlign: 'justify'}}>{productDesc.substring(0,80)}...<a className="show-more" href={`https://www.femmessanspeur.com/products/${productName}`}>SHOW MORE</a></p>
      </div> */}
