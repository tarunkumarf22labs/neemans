  ...
  return (
    <div className="custom-slider-container">
      <div className="nav-icons">
        <a
          href={`https://thesuperfoodfactory.com/products/${productName}`}
          target="__blank"
        >
          <svg
            width="20"
      ...
      <div className="prod-desc">
        <div className="prod-info">
          <a href={`https://thesuperfoodfactory.com/products/${productName}`}>
      ...
      <div id="main__container">
        <a href={`https://thesuperfoodfactory.com/products/${productName}`} style={{textDecoration: "none"}}>
      ...
      {/* <div className="product-deatils">
        <p style={{textAlign: 'justify'}}>{productDesc.substring(0,80)}...<a className="show-more" href={`https://thesuperfoodfactory.com/products/${productName}`}>SHOW MORE</a></p>
      </div> */}
